...
setHTMLElemStyle('display', 'none', 'top-nav', false);
setHTMLElemStyle('display', 'none', 'side-bar', false);
setHTMLElemStyle('display', 'none', 'qr-button-wrapper', false);

setCSSRuleStyle('backgroundImage', 'url(\'./Icons/SJLogo.png\')', '.v3d-simple-preloader-logo', false, '');
...
setHTMLElemStyle('display', 'flex', 'top-nav', false);
setHTMLElemStyle('display', 'flex', 'side-bar', false);
setHTMLElemStyle('display', 'flex', 'qr-button-wrapper', false);
